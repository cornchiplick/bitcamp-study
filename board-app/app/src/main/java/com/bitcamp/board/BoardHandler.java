...
public class BoardHandler {
  ...
  public static void processUpdate() {
    ...
    String updatedTitle = Prompt.inputTitleUpdate(boards[boardIndex].title);
    String updatedContent = Prompt.inputContentUpdate(boards[boardIndex].content);

    String confirm = Prompt.inputString("변경하시겠습니까?(y/n) ");
    if (confirm.equals("y")) {
      boards[boardIndex].title = updatedTitle;
      boards[boardIndex].content = updatedContent;
      ...
      System.out.println("올바른 답변 부탁드립니다.");
      return;
    }
