...
public class MemberHandler {
  ...
  public void list(Map<String, String> paramMap, PrintWriter out) throws Exception {
    ...
    for (Member member : members) {
      ...
      out.printf("  <td>%s</td>", member.password);
  ...
  public void detail(Map<String, String> paramMap, PrintWriter out) throws Exception {
    ...
    if (member == null) {
      ...
      out.println("  <tr>");
      out.println("    <th>회원번호</th>");
      out.printf("    <td><input name='no' type'text' value='%d' readonly='임가오프'></td>", member.no);
      out.println("  </tr>");

      out.println("  <tr>");
      out.println("    <th>이름</th>");
      out.printf("    <td><input name='name' type='text' value='%s' size='60'></td>", member.name);
      out.println("  </tr>");

      out.println("  <tr>");
      out.println("    <th>이메일</th>");
      out.printf("    <td><textarea name='email' rows='10' cols='60'>%s</textarea></td>", member.email);
      out.println("  </tr>");

      out.println("  <tr>");
      out.println("    <th>password</th>");
      out.printf("    <td><input name='password' type='text' value='%s' size='60'></td>", member.password);
      out.println("  </tr>");
  ...
  public void form(Map<String, String> paramMap, PrintWriter out) {
    ...
    out.println("  <tr>");
    out.println("    <th>이름</th>");
    out.println("    <td><input name='name' type='text' size='60'></td>");
    out.println("  </tr>");

    out.println("  <tr>");
    out.println("    <th>이메일</th>");
    out.println("    <td><textarea name='email' rows='10' cols='60'></textarea></td>");
    out.println("  </tr>");

    out.println("  <tr>");
    out.println("    <th>password</th>");
    out.println("    <td><input name='password' type='text' size='60'></td>");
    out.println("  </tr>");
