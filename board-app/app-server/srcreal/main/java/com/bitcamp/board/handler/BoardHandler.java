...
public class BoardHandler {
  ...
  public void detail(Map<String, String> paramMap, PrintWriter out) throws Exception {
    ...
    if (board == null) {
      ...
      out.println("  <tr>");
      out.println("    <th>번호</th>");
      out.printf("    <td><input name='no' type'text' value='%d' readonly='임가오프'></td>", board.no);
      out.println("  </tr>");
  ...
  public void form(Map<String, String> paramMap, PrintWriter out) {
    ...
    out.println("  <tr>");
    out.println("    <th>제목</th>");
    out.println("    <td><input name='title' type='text' size='60'></td>");
    out.println("  </tr>");
    ...
    out.println("  <tr>");
    out.println("    <th>작성자</th>");
    out.println("    <td><input name='writerNo' type='number' size='5'></td></td>");
    out.println("  </tr>");
